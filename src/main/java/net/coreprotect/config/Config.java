...
public class Config extends Language {
    ...
    static {
        ...
        DEFAULT_VALUES.put("storage-type", "postgresql");
        DEFAULT_VALUES.put("table-prefix", "co_");
        DEFAULT_VALUES.put("database-host", "127.0.0.1");
        DEFAULT_VALUES.put("database-port", "5432");
        DEFAULT_VALUES.put("database-name", "database");
        DEFAULT_VALUES.put("database-username", "root");
        DEFAULT_VALUES.put("database-password", "");
        ...
        HEADERS.put("storage-type", new String[] { "# PostgreSQL is used as default.", "# All options are: postgresql, mysql, sqlite" });
    ...
    private void readValues() {
        ...
        this.STORAGE_TYPE = getStorageType(this.getString("storage-type"));
        this.PREFIX = this.getString("table-prefix");
        this.DATABASE_HOST = this.getString("database-host");
        this.DATABASE_PORT = this.getInt("database-port");
        this.DATABASE_NAME = this.getString("database-name");
        this.DATABASE_USERNAME = this.getString("database-username");
        this.DATABASE_PASSWORD = this.getString("database-password");
    ...
    private StorageType getStorageType(String string) {
